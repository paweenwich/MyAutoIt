...
--    {screen="QuestSelectB2",cmd=ClickAt,x=705,y=222},
--    {screen="QuestSelectB2",cmd=ClickAt,x=480,y=385},
    {screen="QuestSelectB2",cmd=ClickAt,x=500,y=300},
--    {screen="QuestSelectB3",cmd=ClickAt,x=480,y=385},
    {screen="QuestSelectB3",cmd=ClickAt,x=550,y=222},
    ...
    {screen="Main/Success2",cmd=ClickAt,x=260,y=330},
...
--    {screen="Main/PartyAutoNoSkill",cmd=ClickAt,x=874,y=683},
    ...
    {screen="Main/Quest3",cmd=ClickAt,x=91,y=312},    
